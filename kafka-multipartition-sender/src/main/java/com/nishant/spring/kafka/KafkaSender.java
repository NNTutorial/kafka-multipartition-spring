...
public class KafkaSender {
	...
	public void send(String topic,Integer partition,Integer key,String message) {
		Message<String> msg=MessageBuilder.withPayload(message).setHeader(KafkaHeaders.MESSAGE_KEY, key).setHeader(KafkaHeaders.PARTITION_ID, partition).setHeader(KafkaHeaders.TOPIC, topic).build();
